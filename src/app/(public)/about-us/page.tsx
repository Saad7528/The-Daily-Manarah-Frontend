        ...
        <div className="space-y-10 text-leading-relaxed">
          ...
          <section className="space-y-4 border-t border-slate-150 dark:border-slate-800 pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs md:text-sm bg-slate-50 dark:bg-slate-950/40 p-5 rounded-xl border border-slate-100 dark:border-slate-900/50">
              ...
              <div>
                ...
                <p className="text-slate-700 dark:text-slate-200 font-semibold mt-1">কাজী রায়হান</p>
              </div>
              <div>
                <span className="font-bold text-slate-400">বার্তা ও অনুসন্ধান প্রধান:</span>
                <p className="text-slate-700 dark:text-slate-200 font-semibold mt-1">এইচ এম তারিকুল ইসলাম</p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-4 border-t border-slate-150 dark:border-slate-800 pt-6">
            <h2 className="text-xl font-bold flex items-center space-x-2 text-slate-900 dark:text-slate-50">
              ...
              <span>যোগাযোগের ঠিকানা (Contact Information)</span>
            </h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs md:text-sm">
              
              <div className="flex items-start space-x-3 p-4 rounded-xl bg-slate-50 dark:bg-slate-950/40 border border-slate-100 dark:border-slate-900/50">
                <MapPin className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                <div>
                  <span className="font-bold text-slate-400">অফিস:</span>
                  <p className="text-slate-700 dark:text-slate-300 font-medium">ঢাকা, বাংলাদেশ</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 p-4 rounded-xl bg-slate-50 dark:bg-slate-950/40 border border-slate-100 dark:border-slate-900/50">
                ...
                <div>
                  <span className="font-bold text-slate-400">হোয়াটসঅ্যাপ / হেল্পলাইন:</span>
                  <p className="text-slate-700 dark:text-slate-300 font-medium">
                    <a href="https://wa.me/8801831818138" target="_blank" rel="noopener noreferrer" className="hover:underline text-emerald-600 dark:text-emerald-400 font-mono">
                      +8801831-818138
                    </a>
                  </p>
                </div>
              ...
              <div className="flex items-start space-x-3 p-4 rounded-xl bg-slate-50 dark:bg-slate-950/40 border border-slate-100 dark:border-slate-900/50 sm:col-span-2">
